<template>
    <Head :title="`Add expense – ${animal.animal_id}`" />
    <AppLayout>
        <div class="p-6 sm:p-8">
            <div class="w-full">
                ...
                <h1 class="mt-2 text-2xl font-bold text-stone-900 sm:text-3xl dark:text-stone-100">Add expense</h1>
                <p class="mt-1 text-stone-500 dark:text-stone-400">Record expense for {{ animal.animal_id }}.</p>
...
function submit() {
    form.post(`/animals/${props.animal.id}/expense`);
}
</script>
