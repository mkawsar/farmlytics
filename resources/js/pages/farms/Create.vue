    ...
    <AppLayout>
        <div class="p-6 sm:p-8">
            <div class="w-full">
                ...
                <h1 class="mt-2 text-2xl font-bold text-stone-900 sm:text-3xl dark:text-stone-100">Add farm</h1>
                <p class="mt-1 text-stone-500 dark:text-stone-400">Create a new farm.</p>
                ...
                <form class="mt-8 space-y-6 rounded-xl border border-stone-200/80 bg-white p-6 shadow-sm dark:border-stone-700 dark:bg-stone-800 sm:p-8" @submit.prevent="submit">
                    ...
                    <div class="flex gap-3 pt-2">
                        ...
                        >
                            {{ form.processing ? 'Creating…' : 'Create farm' }}
                        </button>
                        <Link
                            href="/farms"
